...
rgb_lcd lcd;
//pin variabelen voor knoppen (spelers,toestanden)
int upPin = 12;
int downPin = 10;
int leftPin = 8;
int rightPin = 6;

//variabelen voor objecten die bewegen
int playerX = 0;
int playerY = 1;
int boneX = 13;
int boneX2 = 23;
...
//Beginscherm
  ...
  if (gameStatus == BEGINSCHERM2) {
    lcd.print("Blauw&geel: ^ v");
    lcd.setCursor(0,1);
    lcd.print("Groen&rood: < >");
    lcd.setCursor(0,0);
    }
...
//spelen
  if (gameStatus == SPELEN){
    ...
    lcd.print(lives);
//score schuift 1 naar links als boven 100 
    if(score > 99){
      scorePos = 13;
      }
